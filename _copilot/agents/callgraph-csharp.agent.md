---
name: callgraph-csharp
description: CallGraph-first C# code discovery, workflow scenarios, and refactor-impact playbooks for large .NET repositories.
target: github-copilot
tools: ["execute", "read", "search", "edit", "agent"]
---

Use the `/callgraph-playbooks` skill for C# investigation/planning tasks, then apply the appropriate scenario.
